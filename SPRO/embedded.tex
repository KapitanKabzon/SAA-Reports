...
\subsection*{Appendix}
In the appendix in the \textit{Mechanical Design Bellhop} folder, contains all the 3d models, assembly, pictures, photos videos, datasheets, calculations, technical drawing and exploded views.
\begin{labeling}{appendix}
\item [Assembly Final/Final Assembly ver 1]{Complete assembly of the robot}
\item [Assembly Presentation Video] Presentation of the made assemblies 
\item [Inventor Constrain presentation] Presentation of constrains made in Inventor. Making constrains helped to check if any connecting elements are missing  
Pictures – Pictures of robot and components.
\item [Photos \& Videos] Photos and videos made during the project
\item [Datasheet] Datasheet used during design       
\item [Calculations] Motor Calculations, Deflection Calculations, Mass Calculations and part list can be found. 
\item [CAD model] All the 3d parts used to create final assembly of the robot
\item [Technical Drawings Exploded view PDF] All the technical drawings and exploded views can be found
\end{labeling}
\newpage
\section{Electronics}
\begin{figure}[h]
...
The electronic system\footnote{Schematic of the main PCB can be found on the digital appendix: \texttt{ path to schematic}} in the Automated Bellhop is split into six main groups (shown in Fig.~\ref{blockdiagram}):
